...
**When to use:** Before writing tests for a new unit, and when reviewing tests for coverage gaps.
**Applies to:** requests like "write tests", "review tests" and the `write-tests`, `review-tests` workflow.
