...
description: "Deciding what a component owns: props against state, composition against configuration, and where data is fetched."
tags:
  - design
  - react
whenToUse: Before adding a component or a prop, and whenever a component grows a third responsibility.
activation:
  intents:
    - design a component
