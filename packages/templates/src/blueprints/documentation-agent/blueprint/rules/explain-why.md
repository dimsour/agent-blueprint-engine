...
guidance: Comment the reason, never the mechanics. Write a comment where a reader would otherwise ask "why is it done this way", especially around workarounds, ordering constraints and deliberate deviations.
