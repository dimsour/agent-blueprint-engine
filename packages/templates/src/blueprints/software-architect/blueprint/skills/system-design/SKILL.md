---
name: System design
description: Choosing boundaries, data ownership and failure behaviour before choosing technology.
tags:
  - architecture
...
Give the agent the working knowledge of System design that a senior practitioner carries: the terms
that have precise meanings, the invariants that must hold, and the failure modes that look
reasonable but are not.

## When to Use

Any task that reads or changes System design behaviour. Read this before proposing a design, not
after writing code.
