...
description: Spotting untrusted input reaching a dangerous sink, missing authorisation, and secrets that should not be in the diff.
tags:
  - review
  - security
whenToUse: On every review, and closely when the change touches input handling, auth or configuration.
activation:
  intents:
    - review this
    - security review
