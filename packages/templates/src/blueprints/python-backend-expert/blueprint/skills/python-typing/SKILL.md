---
name: Python typing
description: "Type hints that carry meaning at the boundaries: dataclasses and protocols, narrow return types, and what the checker cannot prove."
tags:
  - python
...
Give the agent the working knowledge of Python typing that a senior practitioner carries: the terms
that have precise meanings, the invariants that must hold, and the failure modes that look
reasonable but are not.

## When to Use

Any task that reads or changes Python typing behaviour. Read this before proposing a design, not
after writing code.
