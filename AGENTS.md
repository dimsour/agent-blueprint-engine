...
Phases P0 to P5 are complete: the model, the compiler, the templates, the web IDE, the graphs and the trust surfaces. P6 (AI) is under way: the package is built, the web app’s side of it is not.
