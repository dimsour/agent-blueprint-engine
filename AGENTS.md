...
Phases P0 to P8 are complete: the model, the compiler, the templates, the web IDE, the graphs, the trust surfaces, the AI layer, GitHub, and the hardening pass. P6-09 checked the AI layer against four endpoint implementations and found seven bugs, all fixed (docs/06). P8 (hardening) is in progress: P8-01 to P8-03 gave Copilot, OpenCode and Pi full adapters, so all five harnesses map what they can and report what they cannot, and P8-04 made a project able to hold a binary asset end to end. P8-05 made an import say which schema version it was written at and what the first save would rewrite. P8-06 put the UI under axe in both themes and fixed what it found, including focus never returning from a dialog. P8-07 measured a 200-artifact project and made evaluation linear again. P8-08 added the deploy config and swept 23 stale "planned" claims out of the docs, with a test that now catches them. P8-09 walks the docs/00 story end to end and found that a link to a view did not survive a reload. P8-12 reviewed the phase and found three defects in the permission and storage work, all fixed. P8-10 and P8-11, the OpenCode and Pi hook runtimes, are recorded but not built.
