...
- `@agent-blueprint/exporters`: the compiler. Claude Code, Codex and Copilot map every concept they can; OpenCode and Pi emit the portable artifacts. All five report what they cannot represent.
