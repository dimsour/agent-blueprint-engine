...
- `@agent-blueprint/exporters`: the compiler. Claude Code, Codex, Copilot and OpenCode map every concept they can; Pi emits the portable artifacts. All five report what they cannot represent.
