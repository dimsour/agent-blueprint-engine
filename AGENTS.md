...
Phases P0 to P6 are complete: the model, the compiler, the templates, the web IDE, the graphs, the trust surfaces and the AI layer. P6-09 checked the AI layer against four endpoint implementations and found seven bugs, all fixed (docs/06). P7 (GitHub) is next.
