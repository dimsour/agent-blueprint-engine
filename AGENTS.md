...
Phases P0 to P5 are complete: the model, the compiler, the templates, the web IDE, the graphs and the trust surfaces. P6 (AI) is built end to end except for P6-09, the check against a real model, which needs a key and a running endpoint.
