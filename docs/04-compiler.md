...
| Emitter                                      | Purpose                                                                                                                                                                                                                                                             |
| -------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `emitReadme(blueprint, targets)`             | Root `README.md`: what the repository is, how to use it with each target, the compiled file map, and how to regenerate. Only generated when no `README.md` exists or the previous manifest owns it.                                                                 |
