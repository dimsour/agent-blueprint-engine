...
| P8 Hardening      | in progress | P8-01 to P8-06 are done: every harness has a full adapter, a project can hold a binary asset, an import says what the first save would change, and the UI is checked against WCAG 2.1 AA in both themes. P8-07 to P8-09 are specified below and not started, plus P8-10 and P8-11, the two hook runtimes those adapters recorded. |
