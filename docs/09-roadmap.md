...
| P8 Hardening      | in progress | P8-01 to P8-08 are done: every harness has a full adapter, a project can hold a binary asset, an import says what the first save would change, the UI is checked against WCAG 2.1 AA in both themes, a 200-artifact project is measured, and the docs no longer describe finished work as planned. P8-09 remains, plus P8-10 and P8-11, the two hook runtimes those adapters recorded. |
