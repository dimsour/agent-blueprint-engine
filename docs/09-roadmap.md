...
| P8 Hardening      | in progress | P8-01 to P8-07 are done: every harness has a full adapter, a project can hold a binary asset, an import says what the first save would change, the UI is checked against WCAG 2.1 AA in both themes, and a 200-artifact project is measured rather than assumed. P8-08 and P8-09 remain, plus P8-10 and P8-11, the two hook runtimes those adapters recorded. |
