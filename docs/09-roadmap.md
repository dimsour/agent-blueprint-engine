...
| P3 Web shell onward | in progress | P3-01 to P3-06 done: shell, storage, state store, dashboard, workspace tree and the entity forms. P3-07 to P3-11 (Markdown editor, inspector actions, palette, wizard, ZIP export) remain. |
